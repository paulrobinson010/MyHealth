...
enum Format {
    ...
    static func metric(_ value: Double?, _ metric: Metric, includeUnit: Bool = true) -> String {
    ...
    static func decimal(_ value: Double, fractionDigits: Int = 0) -> String {
    ...
    static func signed(_ value: Double?, fractionDigits: Int = 1) -> String {
        guard let value, value.isFinite else { return "—" }
    ...
    static func day(_ day: DayKey, style: DateFormatter.Style = .medium) -> String {
    ...
    static func percentile(_ fraction: Double) -> String {
